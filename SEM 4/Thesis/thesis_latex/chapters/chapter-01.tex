...
Beyond the academic contribution, the study is also justified by its
reproducibility and adaptability. The complete analytical codebase, from SQL
extraction through model evaluation, is publicly available on GitHub, enabling
future researchers across Sub-Saharan Africa to replicate, extend, and adapt the
framework to other operators and markets without starting from scratch.
